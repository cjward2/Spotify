...
const Login = () => {
    ...
    useEffect(() => {
        ...
        setTimeout(() => setTypedText(`It's like normal Spotify... except it doesn't make Matt angry.`), 1600);
    }, [])
    ...
    return (
        ...
        <div className="login__container">
            ...
            <Typewriter className="login__typewriter" typing={ 0.8 }>{ typedText }</Typewriter>
